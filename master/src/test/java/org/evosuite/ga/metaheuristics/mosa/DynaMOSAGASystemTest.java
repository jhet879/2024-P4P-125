...
//                "-gpt_key=" + GPTKey, "-use_codamosa", "-use_gpt_mutation", "-use_gpt_crossover", "-use_gpt_initial_pop"};
        ...
        String pathToCut = "D:\\Documents\\UOA\\2024\\Part 4 Project\\Repos\\2024-P4P-125\\examplCodez\\src\\main\\java\\mosalisa\\Stack.java";
        String[] command = new String[]{"-generateMOSuite", "-class", cut, "-projectCP", "../examplCodez/target/classes", "-gpt_key=" + GPTKey, "-use_codamosa", "-path_to_cut", pathToCut};
